...
function getPostList() {
    ...
    const mdPosts = mdFiles.map(file => {
        ...
        const title = (_a = postsDict[slug]) !== null && _a !== void 0 ? _a : slug.replace(/[-_]/g, " ").replace(/\b\w/g, c => c.toUpperCase());
...
app.get('/posts/:slug', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (fs.existsSync(mdPath)) {
        const { marked } = yield import("marked");
